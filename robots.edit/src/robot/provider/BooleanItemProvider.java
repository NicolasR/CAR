...
/**
 * This is the item provider adapter for a {@link robot.Boolean} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class BooleanItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 RobotPackage.Literals.BOOLEAN__VALUE,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		robot.Boolean boolean_ = (robot.Boolean)object;
		return getString("_UI_Boolean_type") + " " + boolean_.isValue();
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(robot.Boolean.class)) {
			case RobotPackage.BOOLEAN__VALUE:
