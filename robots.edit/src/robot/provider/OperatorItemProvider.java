...
/**
 * This is the item provider adapter for a {@link robot.Operator} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class OperatorItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 RobotPackage.Literals.OPERATOR__TYPE,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		EOperator labelValue = ((Operator)object).getType();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Operator.class)) {
			case RobotPackage.OPERATOR__TYPE:
