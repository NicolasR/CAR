...
/**
 * This is the item provider adapter for a {@link robot.Sensor} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SensorItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 RobotPackage.Literals.SENSOR__NAME,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		ESensor labelValue = ((Sensor)object).getName();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Sensor.class)) {
			case RobotPackage.SENSOR__NAME:
