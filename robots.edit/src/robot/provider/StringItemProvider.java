...
/**
 * This is the item provider adapter for a {@link robot.String} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class StringItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 RobotPackage.Literals.STRING__VALUE,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((robot.String)object).getValue();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(robot.String.class)) {
			case RobotPackage.STRING__VALUE:
